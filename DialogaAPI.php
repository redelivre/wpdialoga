...
class DialogaAPI 
{
    ...
    public function getAllProposals()
    {
        ...
        //$json = wp_remote_get('http://login.dialoga.gov.br/api/v1/communities/19195/articles?content_type=ProposalsDiscussionPlugin::Proposal');

        // TODO: insert total of elements - 88 for pagination - 9 pages.

        // main dev - get by proposals TODO: test with apiUrl
        $request = wp_remote_get('http://login.dialoga.gov.br/api/v1/proposals_discussion_plugin/121501/ranking?page=1&per_page=20');
